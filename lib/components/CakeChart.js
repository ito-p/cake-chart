  ...
  _createClass(CakeChart, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          _props$showLabels = _props.showLabels,
          showLabels = _props$showLabels === undefined ? true : _props$showLabels;
      var _props2 = this.props,
          coreRadius = _props2.coreRadius,
          ringWidth = _props2.ringWidth,
          onClick = _props2.onClick,
          getRingProps = _props2.getRingProps,
          getSliceProps = _props2.getSliceProps,
          style = _props2.style,
          data = _props2.data,
          getKey = _props2.getKey,
          stroke = _props2.stroke,
          strokeWidth = _props2.strokeWidth,
          limit = _props2.limit,
          ringWidthFactor = _props2.ringWidthFactor,
          _props2$transitionNam = _props2.transitionName,
          transitionName = _props2$transitionNam === undefined ? classes.pieChart : _props2$transitionNam,
          _props2$labelTransiti = _props2.labelTransitionName,
          labelTransitionName = _props2$labelTransiti === undefined ? classes.labelsBox : _props2$labelTransiti,
          _props2$className = _props2.className,
          className = _props2$className === undefined ? classes.wrapper : _props2$className;
      ...
      var depth = sliceTree.length;
      var appearTimeout = ((depth - 1) / 5 + 0.8) * 1000;
      var enterTimeout = ((depth - 1) / 5 + 0.5) * 1000;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { component: 'div',
              ...
              ref: 'labels' },
            showLabels ? sliceTree.map(function (block, idx) {
    ...
    value: function renderTexts(block, center, key) {
      ...
      var _props3 = this.props,
          getLabelProps = _props3.getLabelProps,
